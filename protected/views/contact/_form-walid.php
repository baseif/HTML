...
?>
        ...
        document.getElementById('nbfield').value = i;
            ...
            $("#items").append('<div><table><tr><td><b>Company</b><input type="text" name="company' + i + '" id="inputcompany' + i + '"></td><td><b>Country</b><input type="text" name="country' + i + '" id="inputcountry' + i + '"></td><td><b>Fielf of interest</b><input type="text" name="function' + i + '" id="inputfunction' + i + '"></td><td><button class="delete" type="button">Delete</button></td></tr></table></div>');
//    n = i-1; 
...
//            var chaine = '';
//            for (c = 0; c < allcompany.length; c++) {
//                chaine = chaine + '{id:' + allcompany[c].id + ', name:"' + allcompany[c].name + '"},';
//                //chaine = chaine + '{"name":"la presse"},';
//            }
            //alert(chaine);
            
            //var obj = JSON.parse(chaine);
           //var obj =  jQuery.parseJSON( chaine );
            $("#inputcompany" + i).tokenInput([<?php
                        ...
                        <div class="row">
                            ...
                            <div id="items">
                                <div>
                                    ...
                                    <table><tr><td><b>Company</b> <input type="text" name="company1" id="inputcompany1"></td>
                                            <td><b>Country</b> <input type="text" name="country1" id="inputcountry1"></td>
                                            <td><b>Field of interest</b> <input type="text" name="function1" id="inputfunction1"></td>
                                        </tr></table>
                                </div>
                            </div>                
