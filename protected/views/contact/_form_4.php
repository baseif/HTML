...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/js/jquery.autocomplete.multiselect.js"></script>
...
<script>
    ...
    var i =0;
        ...
        i++;   
            ...
            $("#items").append('<div><table><tr><td><b>Company</b><input type="text" name="company'+i+'[]" id="inputcompany' + i + '"></td><td><b>Country</b><input type="text" name="country[]" id="inputcountry' + i + '"></td><td><b>Fielf of interest</b><input type="text" name="function[]" id="inputfunction' + i + '"></td><td><button class="delete" type="button">Delete</button></td></tr></table></div>');
            n = i-1; 
            var idcompany = '';
            for (j = 0; j <= n; j++) {
                idcompany = idcompany + document.getElementById('inputcompany' + j).value+';';
            }
            ...
            var url = "<?php echo Yii::app()->request->baseUrl; ?>/index.php/contact/companylist/idcompany/"+idcompany;
...
?>
                        ...
                        <div class="row">
                            ...
                            <div id="items">
                                <div>
                                    <table><tr><td><b>Company</b> <input type="text" name="company0[]" id="inputcompany0"></td>
