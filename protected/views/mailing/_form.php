...
<div class="form">
	...
	<div class="row">
		<div class="form-group">
                                            <label><?php echo  Yii::t('app',' Subject ');?></label>
        ...
        <div class="form-group span-12 pull-left">
                                        <label><?php echo  Yii::t('app',' Date range: ');?></label>
	...
	<div class="row">
            ...
            <div class='box-body pad'>
                                    <form>
                                         <label><?php echo  Yii::t('app','Body  ');?></label>
                                        <textarea id="editor1" name="editor1" rows="10" cols="50">
                                          <?php echo  Yii::t('app','  This is my textarea to be replaced with CKEditor. ');?> 
                                        </textarea>
                                    </form>
                                </div>
        ...
        <div class="row">
           <div class="form-group" style="float:left; width: 45%">
               <fieldset>
                   <legend><?php echo  Yii::t('app',' Client ');?></legend>
		<?php
            ...
            <div class="form-group" style="float:right; width: 45%">
               <fieldset>
                   <legend><?php echo  Yii::t('app','  Journalist');?></legend>
		<?php
