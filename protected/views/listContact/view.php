...
<h3><?php echo  Yii::t('app','Contact List');?></h3>
<?php
echo '
<form action="'.Yii::app()->request->baseUrl.'/index.php/listContact/deleteall/'.$model->list_id.'" method="post">    
...
. '<th>'
        ...
        . 'Select All</th>'
        . '<th><i class="fa fa-building-o fa-lg"> </i> '; echo Yii::t('app','Company')  ;echo'/<i class="fa fa-user fa-lg"></i>  '; echo Yii::t('app','Contact');echo' </th>'
        . '<th>  <i class="fa fa-language fa-lg" ></i> '; echo Yii::t('app','Language');echo' </th>'
        . '<th><i class="fa fa-globe  fa-lg" ></i>'; echo Yii::t('app','Publish Region');echo' </th>'
        . '<th><i class="fa fa-bullseye"></i>' ; echo Yii::t('app','Field of interest');echo'</th>' . '</tr>';
...
echo '<tr>
    <td colspan="5">
    <input class="btn btn-danger pull-right" id="Delete" disabled type="submit" name="Delete" value="';echo Yii::t('app','Delete'); echo'" />
