...
foreach($list as  $value){
 ...
 <td> <div type="button" class="btn btn-info">
 <i class="fa fa-file-text fa-lg"> </i> '.CHtml::link( Yii::t('app','Detail'),array('listContact/view/'.$value->list_id),array('style'=>'color:#fff')).'</div></td>
    

    <td> <div type="button" class="btn btn-danger">
    <i class="fa fa-trash-o fa-lg">  </i> '.CHtml::link( Yii::t('app','Delete'),array('listContact/deletelist/'.$value->list_id),array('onClick'=>Yii::t('app','return confirm("Are you sure to delete this row ?")'),'style'=>'color:#fff')).'</div></td>
</tr>';    
}
