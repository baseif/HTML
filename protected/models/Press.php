...
class Press extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('press_content,press_subject,list_id, press_sender_name, press_sender_email, press_replyto_name, press_replyto_email', 'required'),
    ...
    public function relations() {
        ...
        return array(
            ...
            'pressUser' => array(self::BELONGS_TO, 'Client', 'press_user'),
    ...
    public function attributeLabels() {
        return array(
            ...
            'press_user' => Yii::t('login','Press User'),
            'list_id' => Yii::t('login','List'),
            'press_subject' => Yii::t('login','Press Subject'),
