...
<?php else: ?>
    ...
    <div class="form col-sm-10 well">
        ...
        <div class="panel panel-footer span-10 pull-right">
        <div class="panel-heading">
                ...
                <div id="Heading-Payment" data-toggle="collapse" class="btn btn-primary accordion-heading"data-parent="#accordion" href="#Payment">
                    ...
                    <div class="pull-left"></div><?php echo  Yii::t('app','Choose your subscription');?>
                </div>
                <!--</h4>-->
            </div>
...
<input type="radio" name="typecredit" value="0" class="inputradio"  checked="checked" /><label><?php //echo  Yii::t('app','Free Package');?></label><br />
    <input type="radio" name="typecredit" value="2450" class="inputradio" /><label><?php //echo  Yii::t('app','Annual subscription => 2,450 €');?></label><br />
    
    <input type="radio" name="typecredit" value="350" class="inputradio" /><label><?php //echo  Yii::t('app','Starters Offer => 1000 Credits | 350,00 €');?></label>
