...
function AddToBlack() {
    ...
    var url ="<?php echo Yii::app()->request->baseUrl; ?>/listContact/addcontact/source/"+ tabsource + "/destination/" + tabdestination;
...
function AddAllToBlack() {
    ...
    var url ="<?php echo Yii::app()->request->baseUrl; ?>/listContact/addallcontact/";
//            alert(url);
//            //var url = 'https://tompanther.arvixe.com/~webside/yetgroup.com/demo-webserver/APL/index.php/listContact/addallcontact/source/'+tabsource;              ajaxpsot(tabsource, url,'updatelist');         
...
function RemoveAllFromBlack() {
    ...
    var url ="<?php echo Yii::app()->request->baseUrl; ?>/listContact/removeallcontact/";
...
function RemoveFromBlack() {
    ...
    var url ="<?php echo Yii::app()->request->baseUrl; ?>/listContact/removecontact/destination/" + tabdestination;
